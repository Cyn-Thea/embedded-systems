...
void setup() { 
  ...
  attachInterrupt(digitalPinToInterrupt(servoPin), sec, CHANGE); // attaches an interrupt to the servoPin that calls the sec function when the signal changes.
}
...
void sec() {// function to handle the interrupt
